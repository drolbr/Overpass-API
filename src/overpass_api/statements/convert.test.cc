...
{
  Union_Statement union_(0, (from == "_" ? Attr() : Attr()("into", from)).kvs());

  Id_Query_Statement stmt1(0, Attr()("type", "node")("ref", to_string(ref1 + global_node_offset)).kvs());
  union_.add_statement(&stmt1, "");
  Id_Query_Statement stmt2(0, Attr()("type", "way")("ref", to_string(ref1)).kvs());
  union_.add_statement(&stmt2, "");
  Id_Query_Statement stmt3(0, Attr()("type", "relation")("ref", to_string(ref1)).kvs());
  ...
  Make_Statement stmt5(0, Attr()("type", "derivee").kvs());
  Set_Prop_Statement stmt50(0, Attr()("k", "number").kvs());
  stmt5.add_statement(&stmt50, "");
  Evaluator_Fixed stmt500(0, Attr()("v", derived_num).kvs());
    ...
    std::string from, uint64 ref1, uint64 ref2, uint64 ref3, uint64 ref4)
{
  ...
  Id_Query_Statement stmt1(0, Attr()("type", "relation")("ref", to_string(ref1)).kvs());
  union_.add_statement(&stmt1, "");
  Id_Query_Statement stmt2(0, Attr()("type", "relation")("ref", to_string(ref2)).kvs());
  union_.add_statement(&stmt2, "");
  Id_Query_Statement stmt3(0, Attr()("type", "relation")("ref", to_string(ref3)).kvs());
  union_.add_statement(&stmt3, "");
  Id_Query_Statement stmt4(0, Attr()("type", "relation")("ref", to_string(ref4)).kvs());
  union_.add_statement(&stmt4, "");
    ...
    std::string type, std::string from, uint64 ref1, uint64 ref2, std::string derived_num, uint64 global_node_offset)
{
  ...
  Convert_Statement stmt(0, Attr()("from", from)("type", type).kvs());

  Set_Prop_Statement stmt1(0, Attr()("keytype", "generic").kvs());
  stmt.add_statement(&stmt1, "");
  Evaluator_Generic stmt10(0, Attr().kvs());
    ...
    std::string type, std::string into, uint64 global_node_offset)
{
  ...
  Convert_Statement stmt(0, Attr()("type", type)("into", into).kvs());
  ...
  stmt.execute(rman);
  Print_Statement(0, Attr()("from", into).kvs()).execute(rman);
}
    ...
    std::string type, std::string from, uint64 ref1, uint64 ref2, std::string derived_num, uint64 global_node_offset)
{
  ...
  Set_Prop_Statement stmt2(0, Attr()("k", "extra_key").kvs());
  stmt.add_statement(&stmt2, "");
  Evaluator_Fixed stmt20(0, Attr()("v", "extra_value").kvs());
  stmt2.add_statement(&stmt20, "");

  Set_Prop_Statement stmt3(0, Attr()("k", "node_key").kvs());
  stmt.add_statement(&stmt3, "");
  Set_Prop_Statement stmt4(0, Attr()("k", "number").kvs());
    ...
    std::string type, uint64 global_node_offset)
{
  ...
  Set_Prop_Statement stmt1(0, Attr()("k", "node_key").kvs());
  stmt.add_statement(&stmt1, "");
  Evaluator_Is_Tag stmt10(0, Attr()("k", "node_key").kvs());
  stmt1.add_statement(&stmt10, "");
  Set_Prop_Statement stmt2(0, Attr()("k", "way_key").kvs());
  stmt.add_statement(&stmt2, "");
  Evaluator_Is_Tag stmt20(0, Attr()("k", "way_key").kvs());
  stmt2.add_statement(&stmt20, "");
  Set_Prop_Statement stmt3(0, Attr()("k", "relation_key").kvs());
  stmt.add_statement(&stmt3, "");
  Evaluator_Is_Tag stmt30(0, Attr()("k", "relation_key").kvs());
  stmt3.add_statement(&stmt30, "");
  Set_Prop_Statement stmt4(0, Attr()("k", "number").kvs());
  stmt.add_statement(&stmt4, "");
  Evaluator_Is_Tag stmt40(0, Attr()("k", "number").kvs());
  stmt4.add_statement(&stmt40, "");
    ...
    std::string type, uint64 global_node_offset)
{
  ...
  Convert_Statement stmt1(0, Attr()("type", type).kvs());

  Set_Prop_Statement stmt11(0, Attr()("k", "lat").kvs());
  stmt1.add_statement(&stmt11, "");
  Evaluator_Latitude stmt110(0, Attr().kvs());
  stmt11.add_statement(&stmt110, "");
  Set_Prop_Statement stmt12(0, Attr()("k", "lon").kvs());
  stmt1.add_statement(&stmt12, "");
  Evaluator_Longitude stmt120(0, Attr().kvs());
  stmt12.add_statement(&stmt120, "");

  stmt1.execute(rman);
  Print_Statement(0, Attr().kvs()).execute(rman);

  Make_Statement stmt2(0, Attr()("type", "derivee").kvs());
  Set_Prop_Statement stmt20(0, Attr()("keytype", "geometry").kvs());
  stmt2.add_statement(&stmt20, "");
  Evaluator_Point stmt200(0, Attr().kvs());
  stmt20.add_statement(&stmt200, "");
  Evaluator_Fixed stmt2001(0, Attr()("v", "-15.0").kvs());
  stmt200.add_statement(&stmt2001, "");
  Evaluator_Fixed stmt2002(0, Attr()("v", "5.55").kvs());
  stmt200.add_statement(&stmt2002, "");
  stmt2.execute(rman);

  Convert_Statement stmt3(0, Attr()("type", type).kvs());

  Set_Prop_Statement stmt31(0, Attr()("k", "lat").kvs());
  stmt3.add_statement(&stmt31, "");
  Evaluator_Latitude stmt310(0, Attr().kvs());
  stmt31.add_statement(&stmt310, "");
  Set_Prop_Statement stmt32(0, Attr()("k", "lon").kvs());
  stmt3.add_statement(&stmt32, "");
  Evaluator_Longitude stmt320(0, Attr().kvs());
    ...
    std::string type, uint64 global_node_offset)
{
  ...
  Set_Prop_Statement stmt11(0, Attr()("k", "ref").kvs());
  stmt1.add_statement(&stmt11, "");
  Evaluator_Per_Member stmt110(0, Attr().kvs());
  stmt11.add_statement(&stmt110, "");
  Evaluator_Ref stmt1100(0, Attr().kvs());
  stmt110.add_statement(&stmt1100, "");

  Set_Prop_Statement stmt12(0, Attr()("k", "refpos").kvs());
  stmt1.add_statement(&stmt12, "");
  Evaluator_Per_Member stmt120(0, Attr().kvs());
  stmt12.add_statement(&stmt120, "");
  Evaluator_Plus stmt1200(0, Attr().kvs());
  stmt120.add_statement(&stmt1200, "");
  Evaluator_Plus stmt12001(0, Attr().kvs());
  stmt1200.add_statement(&stmt12001, "");
  Evaluator_Pos stmt120011(0, Attr().kvs());
  stmt12001.add_statement(&stmt120011, "");
  Evaluator_Fixed stmt120012(0, Attr()("v", ":").kvs());
  stmt12001.add_statement(&stmt120012, "");
  Evaluator_Ref stmt12002(0, Attr().kvs());
  stmt1200.add_statement(&stmt12002, "");

  Set_Prop_Statement stmt13(0, Attr()("k", "full").kvs());
  stmt1.add_statement(&stmt13, "");
  Evaluator_Per_Member stmt130(0, Attr().kvs());
  stmt13.add_statement(&stmt130, "");
  Evaluator_Plus stmt1300(0, Attr().kvs());
  stmt130.add_statement(&stmt1300, "");
  Evaluator_Plus stmt13001(0, Attr().kvs());
  stmt1300.add_statement(&stmt13001, "");
  Evaluator_Plus stmt130011(0, Attr().kvs());
  stmt13001.add_statement(&stmt130011, "");
  Evaluator_Plus stmt1300111(0, Attr().kvs());
  stmt130011.add_statement(&stmt1300111, "");
  Evaluator_Membertype stmt13001111(0, Attr().kvs());
  stmt1300111.add_statement(&stmt13001111, "");
  Evaluator_Fixed stmt13001112(0, Attr()("v", ",").kvs());
  stmt1300111.add_statement(&stmt13001112, "");
  Evaluator_Ref stmt1300112(0, Attr().kvs());
  stmt130011.add_statement(&stmt1300112, "");
  Evaluator_Fixed stmt130012(0, Attr()("v", ",").kvs());
  stmt13001.add_statement(&stmt130012, "");
  Evaluator_Role stmt13002(0, Attr().kvs());
  stmt1300.add_statement(&stmt13002, "");

  Set_Prop_Statement stmt14(0, Attr()("k", "vertexrefpos").kvs());
  stmt1.add_statement(&stmt14, "");
  Evaluator_Per_Vertex stmt140(0, Attr().kvs());
  stmt14.add_statement(&stmt140, "");
  Evaluator_Plus stmt1400(0, Attr().kvs());
  stmt140.add_statement(&stmt1400, "");
  Evaluator_Plus stmt14001(0, Attr().kvs());
  stmt1400.add_statement(&stmt14001, "");
  Evaluator_Pos stmt140011(0, Attr().kvs());
  stmt14001.add_statement(&stmt140011, "");
  Evaluator_Fixed stmt140012(0, Attr()("v", ":").kvs());
  stmt14001.add_statement(&stmt140012, "");
  Evaluator_Ref stmt14002(0, Attr().kvs());
    ...
    std::string type, uint64 global_node_offset)
{
  ...
  stmt.add_statement(&stmt1, "");
  Evaluator_Geometry stmt10(0, Attr().kvs());
  stmt1.add_statement(&stmt10, "");
