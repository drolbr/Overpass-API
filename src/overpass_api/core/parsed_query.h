...
public:
  ...
  Output_Handler_Params* get_output_handler() const { return output_handler; }
  void set_output_handler(Output_Handler_Params* output_handler);
...
private:
  ...
  Output_Handler_Params* output_handler;
...
inline void Parsed_Query::set_output_handler(Output_Handler_Params* output_handler_)
{
