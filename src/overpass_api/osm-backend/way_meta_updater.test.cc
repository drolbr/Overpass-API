...
// weitere Testfälle:
// - ohne pre: impl anders + current gleich
// - ohne pre: impl gleich + current impl anders
// - ohne pre: Bestand + current impl anders
// - mit pre: current + impl gleich
// - mit pre: impl anders
// - mit pre: impl 2x anders
// - mit pre: impl anders + current gleich
// - mit pre: impl gleich + current impl anders
