...
int main(int argc, char* args[])
{
       ...
       || string(args[2]) == "interpreter_41")
  {
    ...
    if (false/*string(args[2]) == "interpreter_25"*/)
      cout<<"Location: http://www.openstreetmap.org/browse/node/1\n\n";
    else if (string(args[2]) == "interpreter_39")
    ...
    else if (false/*string(args[2]) == "interpreter_29"*/)
      cout<<"Location: http://www.openstreetmap.org/browse/relation/1\n\n";
  }
    ...
    || string(args[2]) == "interpreter_36" || string(args[2]) == "interpreter_37")
  {
	...
	cout<<"<h1>3 results found</h1>\n";
	  ...
	  || string(args[2]) == "interpreter_37")
      {
        ...
        "  <input type=\"hidden\" name=\"lat\" value=\"51.0125000\"/>\n"
        "  <input type=\"hidden\" name=\"lon\" value=\"7.0125000\"/>\n"
        "  <input type=\"hidden\" name=\"zoom\" value=\"17\"/>\n"
        "</form>\n"
        "</div>\n"
        "\n"
        "<p>Node <strong>1</strong>, lat: 51.0125000, lon: 7.0125000,<br/>\n";
	...
	cout<<
        "\n"
        "<div style=\"min-height:300px;\">\n"
        "<div id=\"map_node_123\" style=\"width:300px;height:300px;float:right;\">\n"
        "<div id=\"map_node_123_progressbar\">Loading data ...</div>\n"
        "<form class=\"map_descriptor\" action=\"map_node_123\">\n"
        "  <input type=\"hidden\" name=\"url\" value=\"interpreter?data=node%28123%29%3Bout+skel%3B\"/>\n"
        "  <input type=\"hidden\" name=\"lat\" value=\"51.0875000\"/>\n"
        "  <input type=\"hidden\" name=\"lon\" value=\"7.0625000\"/>\n"
        "  <input type=\"hidden\" name=\"zoom\" value=\"17\"/>\n"
        "</form>\n"
        "</div>\n"
        "\n"
        "<p>Node <strong>123</strong>, lat: 51.0875000, lon: 7.0625000,<br/>\n"
        "\n"
        "<a href=\"http://www.openstreetmap.org/browse/node/123\">Browse on openstreetmap.org</a></p>\n"
        "</div>\n";
	...
	"<div style=\"min-height:300px;\">\n"
        ...
        "  <input type=\"hidden\" name=\"lat\" value=\"51.0427264\"/>\n"
        "  <input type=\"hidden\" name=\"lon\" value=\"7.0254591\"/>\n"
        "  <input type=\"hidden\" name=\"zoom\" value=\"13\"/>\n"
        "</form>\n"
        "</div>\n"
        "\n"
        "<p>Way <strong>1</strong>, bounding box south: 51.0296192, west: 7.0123520, north: 51.0558335, east: 7.0385663,<br/>\n";
	if (string(args[2]) != "interpreter_36")
	  cout<<
          "way_key = way_few<br/>\n"
	...
	"\n"
        ...
        "  <input type=\"hidden\" name=\"lat\" value=\"51.0820480\"/>\n"
        "  <input type=\"hidden\" name=\"lon\" value=\"7.0778880\"/>\n"
        "  <input type=\"hidden\" name=\"zoom\" value=\"11\"/>\n"
        "</form>\n"
        "</div>\n"
        "\n"
        "<p>Way <strong>2</strong>, bounding box south: 51.0296192, west: 7.0254592, north: 51.1344767, east: 7.1303167,<br/>\n"
        "way_key = way_few<br/>\n"
	...
	"<div style=\"min-height:300px;\">\n"
        ...
        "  <input type=\"hidden\" name=\"lat\" value=\"51.0296192\"/>\n"
        "  <input type=\"hidden\" name=\"lon\" value=\"7.0254591\"/>\n"
        "  <input type=\"hidden\" name=\"zoom\" value=\"11\"/>\n"
        "</form>\n"
        "</div>\n"
	"\n"
        "<p>Relation <strong>1</strong>, bounding box south: 50.9771904, west: 6.9730304, north: 51.0820479, east: 7.0778879,<br/>\n";
	if (string(args[2]) != "interpreter_36")
	  cout<<
          "relation_key = relation_few<br/>\n"
          "relation_key_2/4 = relation_value_1<br/>\n";
	cout<<
        " members: node <strong>1</strong> &quot;one&quot;, node <strong>42</strong> &quot;two&quot;<br/>\n"
