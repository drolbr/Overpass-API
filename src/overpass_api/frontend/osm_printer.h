...
#ifndef DE__OSM3S___OVERPASS_API__FRONTEND__OSM_PRINTER_H
#define DE__OSM3S___OVERPASS_API__FRONTEND__OSM_PRINTER_H
...
struct Output_Mode
{
  ...
  static const unsigned int REDACTED = 0x800;
...
// Only relevant for diff activities
...
struct OSM_Data_Printer
{
  ...
  virtual void print_redacted(Output_Mode mode, uint32_t skel_type, const Full_Monotype_Meta* meta) = 0;
};
