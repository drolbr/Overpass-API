...
File_Properties* de_osm3s_file_ids::NODES
  = new OSM_File_Properties("nodes", 1*1024*1024);
File_Properties* de_osm3s_file_ids::NODE_TAGS_LOCAL
  = new OSM_File_Properties("node_tags_local", 1*1024*1024);
File_Properties* de_osm3s_file_ids::NODE_TAGS_GLOBAL
  = new OSM_File_Properties("node_tags_global", 1*1024*1024);
File_Properties* de_osm3s_file_ids::WAYS
  = new OSM_File_Properties("ways", 1*1024*1024);
File_Properties* de_osm3s_file_ids::WAY_TAGS_LOCAL
  = new OSM_File_Properties("way_tags_local", 1*1024*1024);
File_Properties* de_osm3s_file_ids::WAY_TAGS_GLOBAL
  = new OSM_File_Properties("way_tags_global", 1*1024*1024);
File_Properties* de_osm3s_file_ids::RELATIONS
  = new OSM_File_Properties("relations", 1*1024*1024);
File_Properties* de_osm3s_file_ids::RELATION_ROLES
  = new OSM_File_Properties("relation_roles", 1*1024*1024);
File_Properties* de_osm3s_file_ids::RELATION_TAGS_LOCAL
  = new OSM_File_Properties("relation_tags_local", 1*1024*1024);
File_Properties* de_osm3s_file_ids::RELATION_TAGS_GLOBAL
  = new OSM_File_Properties("relation_tags_global", 1*1024*1024);
