...
shortcuts = cgi-bin/download cgi-bin/poi cgi-bin/elems bin/nodes-csv-lat-lon-name cgi-bin/nodes-csv
...
bin/nodes-csv-lat-lon-name: utils/nodes-csv-lat-lon-name.c expat_justparse_interface.h expat_justparse_interface.o
	g++ -lexpat -o $@ -O3 -Wall $^
