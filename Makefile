...
shortcuts = cgi-bin/download cgi-bin/poi cgi-bin/elems bin/nodes-csv-lat-lon-name cgi-bin/nodes-csv bin/memberlist cgi-bin/nodes-csv-gzip cgi-bin/sketch-route cgi-bin/sketch-line bin/sketch-route-svg
