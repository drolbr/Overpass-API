...
objects = expat_justparse_interface.o cgi-helper.o user_interface.o script_queries.o script_tools.o script-interpreter.o $(stmts)
...
script_queries.o: script_queries.c script_queries.h script_datatypes.h
